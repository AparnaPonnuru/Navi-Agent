            ...
            <div className="route-map">
              ...
              <div className="route-station">
                ...
                <div className="route-station-copy">
                  ...
                  />
                  <span>{futureCoords || "Destination coordinates optional"}</span>
                </div>
              </div>
            </div>

            {/* <div className="coordinate-tools">
              <button className="detect-btn" type="button" onClick={detectCurrentCoordinates} disabled={detecting}>
                <IconNavigation size={16} />
                {detecting ? "Detecting..." : "Auto-detect current"}
              </button>
              <div className="coord-grid">
                <label className="coord-field">
                  ...
                  <input
                    ...
                    placeholder="17.38504, 78.48667"
                  />
                </label>
                <label className="coord-field">
                  <span>Future coordinates</span>
                  <input
                    value={futureCoords}
                    onChange={e => setFutureCoords(e.target.value)}
                    placeholder="12.97160, 77.59456"
                  />
                </label>
              </div>
              {coordinateError && <div className="coord-error">{coordinateError}</div>}
            </div> */}
